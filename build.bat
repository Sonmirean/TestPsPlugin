...
:: Libraries root
set ThirdPartyDirPath=C:\C libraries
...
set CommonIncludePaths=/I "%ThirdPartyDirPath%"\psapi 
::/I "%ThirdPartyDirPath%"\imgui-master
...
:: Determine build commands based on build type
if "%BuildType%"=="debug" (
